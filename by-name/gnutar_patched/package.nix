...
stdenv.mkDerivation (finalAttrs: {
  ...
  '' + ''
    patch -p1 < ${fetchurl {
      url = "https://cgit.git.savannah.gnu.org/cgit/tar.git/patch/?id=b8d8a61b25588caca4efaf9bdd2e3f1a49da77e3";
      hash = "sha256-TD43A2guaQQAbRc44fh8nUqEr9r51Qd+4B379lZmkjI=";
    }} || true
    sed -i '/purge_directory (char const \*directory_name)/,/^}/ s/return false;/return;/g' src/incremen.c
  '';
