...
To use modules: (Note that system isn't defined by default. You could define it or replace it with a constant like `x86_64-linux`)
```nix
  imports = [
...
+ firefox_nightly, nss_git, shared folder, proton-bin, linux-cachyos, zfs-impermanence-on-shutdown.nix <https://github.com/chaotic-cx/nyx/commit/aacb796ccd42be1555196c20013b9b674b71df75>
