...
fun PlayerSettings(navController: NavController) {
    ...
    Scaffold(
        ...
        Column(
            ...
            PreferenceGroup(title = "player") {
                item {
                    EnumListPreference(
                        ...
                        valueText = {
                            when (it) {
                                AudioQuality.HIGHEST -> "audio_quality_max"
                                AudioQuality.HIGH -> "audio_quality_high"
                                AudioQuality.AUTO -> "audio_quality_auto"
                ...
                item {
                    SwitchPreference(
                        title = { Text("audio_crossfade_title") },
                        description = "audio_crossfade_description",
                        icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
                ...
                item {
                    SwitchPreference(
                        title = { Text("crossfade_gapless_title") },
                        description = "crossfade_gapless_description",
                        icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
                ...
                item {
                    SwitchPreference(
                        title = { Text("audio_normalization") },
                        icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
                ...
                item {
                    SwitchPreference(
                        title = { Text("audio_offload") },
                        description = "audio_offload_desc",
                        icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
                ...
                item {
                    SwitchPreference(
                        title = { Text("seek_seconds_addup") },
                        description = "seek_seconds_addup_description",
                        icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
                ...
                item {
                    SwitchPreference(
                        title = { Text("pause_on_device_mute") },
                        description = "pause_on_device_mute_desc",
                        icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
                ...
                item(visible = pauseOnDeviceMute) {
                    ...
                    val disabledLabel = "device_mute_recovery_volume_disabled"
                    ...
                    NumberPickerPreference(
                        title = { Text("device_mute_recovery_volume") },
                        icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
                ...
                item {
                    SwitchPreference(
                        title = { Text("auto_start_on_bluetooth") },
                        description = "auto_start_on_bluetooth_desc",
                        icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
            ...
            PreferenceGroup(title = "sponsor_block_group") {
            ...
            PreferenceGroup(title = "queue") {
                item {
                    SwitchPreference(
                        title = { Text("persistent_queue") },
                        description = "persistent_queue_desc",
                        icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
                ...
                item {
                    SwitchPreference(
                        title = { Text("permanent_shuffle") },
                        description = "permanent_shuffle_desc",
                        icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
                ...
                item {
                    SwitchPreference(
                        title = { Text("auto_download_on_like") },
                        description = "auto_download_on_like_desc",
                        icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
                ...
                item {
                    SwitchPreference(
                        title = { Text("auto_skip_next_on_error") },
                        description = "auto_skip_next_on_error_desc",
                        icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
            ...
            PreferenceGroup(title = "misc") {
                item {
                    SwitchPreference(
                        title = { Text("stop_music_on_task_clear") },
                        icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
                ...
                item {
                    SwitchPreference(
                        title = { Text("external_downloader") },
                        description = "external_downloader_desc",
                        icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
                ...
                item {
                    PreferenceEntry(
                        title = { Text("external_downloader_package") },
                        description = externalDownloaderPackage.ifEmpty { "external_downloader_package_desc" },
                        icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
...
private fun SponsorBlockApiUrlDialog(
    ...
    TextFieldDialog(
        title = { Text("sponsor_block_api_url") },
...
private fun PreferenceGroupScope.sponsorBlockPreferences(
    ...
    item {
        ...
        MultiSelectListPreference(
            title = { Text("sponsor_block_categories") },
            description = "sponsor_block_categories_desc",
            icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
...
private fun PreferenceGroupScope.playbackPerformancePreferences(
    ...
    item {
        SwitchPreference(
            title = { Text("low_data_mode_title") },
            description = "low_data_mode_description",
            icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
    ...
    item {
        SwitchPreference(
            title = { Text("preload_next_song_title") },
            description = "preload_next_song_warning",
            icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
