...
private fun CanvasSettingsContent(
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text("archivetune_canvas") },
                navigationIcon = {
                    IconButton(onClick = onBack) {
                        Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), "back_button_desc")
                    }
                },
            )
        },
...
private fun CanvasSettingsBody(
    ...
    Column(
        ...
        Surface(
            ...
            CanvasSwitchRow(
                title = "canvas_enable",
                description = "archivetune_canvas_desc",
                checked = model.configuration.enabled,
                enabled = !model.busy,
                onCheckedChange = onEnabled,
            )
        }
        CanvasSection(title = "canvas_source") {
                ...
                sources.forEach { source ->
                    ...
                    CanvasChoiceRow(
                        ...
                        description = when (source) {
                            CanvasSource.ALL -> "canvas_source_all_desc"
                            CanvasSource.SPOTIFY -> "canvas_spotify_desc"
                            else -> null
                        },
        ...
        Surface(shape = MaterialTheme.shapes.large, color = MaterialTheme.colorScheme.surfaceContainer) {
            CanvasSwitchRow(
                title = "canvas_wifi_only",
                description = "canvas_wifi_only_desc",
        ...
        Row(
            ...
            TextButton(onClick = onRefresh, enabled = model.canRefreshHealth && !model.busy) {
                Row(
                    ...
                    Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null, modifier = remember { Modifier.size(18.dp) })
                    Text("refresh")
                }
            }
        }
...
@Composable
private fun CanvasHealthRow(title: String, health: CanvasHealth, iconRes: Int, shape: Shape) {
        ...
        Column(verticalArrangement = remember { Arrangement.spacedBy(SettingsDimensions.SegmentedItemGap) }) {
            ...
            Surface(
                ...
                Row(
                    ...
                    Column(modifier = remember { Modifier.weight(1f) }) {
                        Text("max_cache_size", style = MaterialTheme.typography.bodyLarge)
                        Text(
                    ...
                    Icon(
                        androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null,
            ...
            Surface(
                ...
                Row(
                    ...
                    Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null, modifier = remember { Modifier.size(SettingsDimensions.RowIconInnerSize) })
                    Text(
                        text = "clear_canvas_cache",
                        modifier = remember { Modifier.weight(1f) },
...
@Composable
private fun CanvasSectionIcon(iconRes: Int, tint: Color) {
    Surface(
...
private fun CanvasSettingsDialogs(model: CanvasSettingsUiModel, onAction: (CanvasSettingsAction) -> Unit) {
    ...
    when (model.dialog) {
        ...
        CanvasSettingsDialog.CLEAR_CACHE -> AlertDialog(
            onDismissRequest = onDismiss,
            title = { Text("clear_canvas_cache") },
            text = { Text("clear_canvas_cache_dialog") },
...
@Composable
private fun CanvasSettingsFailure(messageRes: Int, onAction: (CanvasSettingsAction) -> Unit, modifier: Modifier) {
