...
fun DiscordExperimental(navController: NavController) {
    ...
    Scaffold { inner ->
        Column(Modifier.fillMaxSize()) {
            TopAppBar(
                title = { Text("experiment_settings") },
                navigationIcon = {
            ...
            LazyColumn(
                ...
                item {
                    PreferenceGroup(title = "translator_options") {
                        item {
                            SwitchPreference(
                                title = { Text("enable_translator") },
                                description = "enable_translator_desc",
                ...
                item {
                    PreferenceGroup(title = "discord_button_options") {
                        item {
                            SwitchPreference(
                                title = { Text("show_button") },
                                description = "show_button1_description",
                                icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
                        ...
                        item(visible = button1Enabled) {
                            ListPreference(
                                title = { Text("discord_activity_button_1_url") },
                                icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
                        ...
                        item(visible = button1Enabled) {
                            EditTextPreference(
                                title = { Text("discord_activity_button1_label") },
                                icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
                                value = button1Label,
                        ...
                        item(visible = button1Enabled && button1UrlSource == "custom") {
                            EditTextPreference(
                                title = { Text("discord_activity_button1_url") },
                                icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
                        ...
                        item {
                            SwitchPreference(
                                title = { Text("show_button") },
                                description = "show_button2_description",
                                icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
                        ...
                        item(visible = button2Enabled) {
                            ListPreference(
                                title = { Text("discord_activity_button_2_url") },
                                icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
                        ...
                        item(visible = button2Enabled) {
                            EditTextPreference(
                                title = { Text("discord_activity_button2_label") },
                                icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
                                value = button2Label,
                        ...
                        item(visible = button2Enabled && button2UrlSource == "custom") {
                            EditTextPreference(
                                title = { Text("discord_activity_button2_url") },
                                icon = { Icon(androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent), null) },
...
private fun discordExperimentalButtonUrlSourceLabel(value: String): String =
    when (value) {
        "songurl" -> "discord_url_source_song"
        "artisturl" -> "discord_url_source_artist"
        "albumurl" -> "discord_url_source_album"
        "custom" -> "discord_url_source_custom"
        else -> value
    }
