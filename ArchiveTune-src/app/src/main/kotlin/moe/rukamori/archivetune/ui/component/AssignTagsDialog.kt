        ...
        Column(
            ...
            FlowRow(
                ...
                TextButton(
                    ...
                    Text(text = "assign_tags_to_playlists")
                }
            }
...
private fun AssignTagRow(
    ...
    SegmentedListItem(
        ...
        trailingContent = {
            Icon(
                painter =
                    androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Transparent) R.drawable.check else R.drawable.add,
                    ),
...
private fun AssignTagsToPlaylistsDialog(
    ...
    PlaylistTagsDialogScaffold(onDismiss = onDismiss) {
        Column(
            ...
            AssignTagsHeader(
                title = "assign_tags_to_playlists",
                subtitle =
                    pluralStringResource(
                        R.plurals.n_selected,
