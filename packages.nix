...
rec {
  ...
  */
  ...
  davinci-resolve200 = pkgs.callPackage ../by-name/da/davinci-resolve/package.nix { };
  davinci-resolve-studio200 = pkgs.callPackage ../by-name/da/davinci-resolve/package.nix {
    studioVariant = true;
  };
